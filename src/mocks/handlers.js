...
function translate(updatedFace) {
  ...
  updatedFace[dimension[0]] = fakeCamera.face[dimension[0]] + 2 * direction;
  updatedFace[dimension[1]] = fakeCamera.face[dimension[1]] + 2 * direction;
...
function getFreshFace() {
  fakeCamera.face = window.structuredClone(defaultFace);
}
